...
## Modified Philip Law 2021-11-25 to create a fragment file only for specified chromosome
...
def parseargs(arguments):
    ...
    parser.add_argument("--chrom", help="Chromosome of interest", required=True) #assumes chromosome in length file and chrom variable are the same format (ie both with or without "chr")
